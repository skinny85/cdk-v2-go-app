...
type CdkV1GoSampleAppStackProps struct {
	awscdk.StackProps
}

func NewCdkV1GoSampleAppStack(scope constructs.Construct, id string, props *CdkV1GoSampleAppStackProps) awscdk.Stack {
...
func main() {
	...
	NewCdkV1GoSampleAppStack(app, "CdkV1GoSampleAppStack", &CdkV1GoSampleAppStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
